...
const phases: Phase[] = [
  ...
  },
  {
    ...
    number: PHASE_CONFIG.planninganddesign.order,
    title: PHASE_CONFIG.planninganddesign.label,
    status: 'in-progress',
    progress: 65,
    tasks: [
  ...
  {
    id: 'delivery',
    number: PHASE_CONFIG.delivery.order,
    title: PHASE_CONFIG.delivery.label,
    status: 'pending',
    progress: 0,
    tasks: [
...
export const MOCK_PROJECT_WITH_PHASES: ProjectWithPhases = {
  ...MOCK_PROJECTS[0],
  phases,
};

// Export phases separately
export { phases as MOCK_PHASES };
